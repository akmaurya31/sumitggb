      ...
      <footer className={props.className}>
        <footer className="main">
          ...
          <section className=" footer-mid">
            <div className="11container pt-10 pb-10">
              <div className="11row grid grid-cols-12">

                <div
                  className="sm:col-span-12 sm:col-start-2 col-span-3 footer-link-widget sm:w-[40%] col wow animate__animated animate__fadeInUp"
                  data-wow-delay=".2s"
                >
                ...
                <div
                  className="sm:col-span-12 sm:col-start-2  col-span-3  footer-link-widget sm:w-[50%] col wow animate__animated animate__fadeInUp pr-10"
                  data-wow-delay=".4s"
                >
                  <div>
                ...
                <div
                  className="sm:col-span-12 sm:col-start-2 col-span-3 footer-link-widget sm:w-[60%] col wow animate__animated animate__fadeInUp"
                  data-wow-delay=".2s"
                >
                  <h4 className="widget-title footer-heading-link">
                   Membership
                ...
                <div className="sm:col-span-12 sm:col-start-2 col-span-3  col">
